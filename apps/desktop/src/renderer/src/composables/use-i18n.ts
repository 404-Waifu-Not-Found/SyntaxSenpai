...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'settings.overlayWindow': 'Overlay window',
    'settings.overlayWindowDescription': 'Keep the app in a small always-on-top window so you can chat while working in other apps.',
    'settings.overlayWindowHint': 'You can drag and resize the window directly. Its position and size are saved automatically.',
    ...
    'toast.overlayWindowEnabled': 'Overlay window enabled',
    'toast.overlayWindowDisabled': 'Overlay window disabled',
  ...
  zh: {
    ...
    'settings.overlayWindow': '悬浮窗',
    'settings.overlayWindowDescription': '让应用以一个始终置顶的小窗口显示，方便你在其他软件上工作时随时聊天。',
    'settings.overlayWindowHint': '可以直接拖动和调整窗口大小，位置和尺寸会自动保存。',
    ...
    'toast.overlayWindowEnabled': '悬浮窗已开启',
    'toast.overlayWindowDisabled': '悬浮窗已关闭',
  ...
  fr: {
    ...
    'settings.overlayWindow': 'Fenêtre flottante',
    'settings.overlayWindowDescription': 'Garde l’application dans une petite fenêtre toujours au premier plan pour discuter tout en travaillant ailleurs.',
    'settings.overlayWindowHint': 'Vous pouvez déplacer et redimensionner la fenêtre directement. Sa position et sa taille sont sauvegardées automatiquement.',
    ...
    'toast.overlayWindowEnabled': 'Fenêtre flottante activée',
    'toast.overlayWindowDisabled': 'Fenêtre flottante désactivée',
  ...
  ru: {
    ...
    'settings.overlayWindow': 'Плавающее окно',
    'settings.overlayWindowDescription': 'Держит приложение в небольшом окне поверх остальных, чтобы можно было общаться во время работы в других программах.',
    'settings.overlayWindowHint': 'Окно можно перетаскивать и менять его размер напрямую. Положение и размер сохраняются автоматически.',
    ...
    'toast.overlayWindowEnabled': 'Плавающее окно включено',
    'toast.overlayWindowDisabled': 'Плавающее окно выключено',
  ...
  ja: {
    ...
    'settings.overlayWindow': 'フローティングウィンドウ',
    'settings.overlayWindowDescription': '他のアプリで作業しながら会話できるよう、常に最前面の小さなウィンドウで表示します。',
    'settings.overlayWindowHint': 'ウィンドウは直接ドラッグとリサイズができます。位置とサイズは自動保存されます。',
    ...
    'toast.overlayWindowEnabled': 'フローティングウィンドウを有効にしました',
    'toast.overlayWindowDisabled': 'フローティングウィンドウを無効にしました',
