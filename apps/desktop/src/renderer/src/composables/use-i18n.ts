...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'pet.open': 'Open desktop pet',
    'pet.returnToWindow': 'Return to normal window',
    'pet.openFailed': 'Could not open desktop pet',
    'pet.returnFailed': 'Could not return to the normal window',
    'pet.stage': 'Desktop pet character',
    'pet.live2dNotBound': 'No Live2D model is assigned to this character yet.',
    'pet.openSettings': 'Open settings',
    'pet.contextHint': 'Right-click to open pet options',
    'pet.menu': 'Desktop pet options',
    'pet.lockPosition': 'Lock position',
    'pet.dragToMove': 'Drag to move chat window',
    'pet.closeMenu': 'Close menu',
    'pet.showChat': 'Show chat window',
    'pet.hideChat': 'Hide chat window',
    'pet.chatBubbleOpacity': 'Chat bubble opacity',
    'pet.warThunderCopilot': 'War Thunder copilot',
    'pet.copilotSettingsDescription': 'When the desktop pet is open, this setting reads local War Thunder telemetry on port 8111. It does not control the game and stays inactive in normal window mode.',
    'pet.enableCopilot': 'Enable War Thunder copilot',
    'pet.disableCopilot': 'Disable War Thunder copilot',
    'pet.copilotOn': 'On',
    'pet.copilotOff': 'Off',
    'pet.copilotStatus': 'Status',
    'pet.miniGames': 'Mini-games',
    'pet.copilotListening': 'Listening',
    'pet.copilotWaiting': 'Waiting for desktop pet',
    'pet.copilotNotListening': 'Not listening',
    ...
    'games.close': 'Close',
    'games.reset': 'Restart',
    'games.dialogueError': 'Character reply failed: {message}',
    ...
    'gomoku.game': 'Game',
    'gomoku.organizing': '{name} is composing a reply…',
  ...
  zh: {
    'pet.open': '开启桌宠模式',
    'pet.returnToWindow': '返回普通窗口',
    'pet.openFailed': '打开桌宠失败',
    'pet.returnFailed': '返回普通窗口失败',
    'pet.stage': '桌宠角色',
    'pet.live2dNotBound': '当前角色还没有绑定 Live2D 模型。',
    'pet.openSettings': '打开设置',
    'pet.contextHint': '右键打开桌宠选项',
    'pet.menu': '桌宠选项',
    'pet.lockPosition': '锁定位置',
    'pet.dragToMove': '拖动此处移动聊天窗口',
    'pet.closeMenu': '关闭菜单',
    'pet.showChat': '显示聊天窗口',
    'pet.hideChat': '隐藏聊天窗口',
    'pet.chatBubbleOpacity': '聊天气泡透明度',
    'pet.warThunderCopilot': 'War Thunder 副驾',
    'pet.copilotSettingsDescription': '桌宠窗口开启时读取本机 War Thunder 遥测数据。不会控制游戏，也不会在普通窗口模式下运行。',
    'pet.enableCopilot': '开启 War Thunder 副驾',
    'pet.disableCopilot': '关闭 War Thunder 副驾',
    'pet.copilotOn': '已开启',
    'pet.copilotOff': '已关闭',
    'pet.copilotStatus': '当前状态',
    'pet.miniGames': '小游戏',
    'pet.copilotListening': '监听中',
    'pet.copilotWaiting': '等待桌宠开启',
    'pet.copilotNotListening': '未监听',
    'games.tictactoe': '井字棋',
    'games.connect4': '四子棋',
    'games.chess': '国际象棋',
    'games.center': '小游戏中心',
    ...
    'games.close': '关闭',
    'games.reset': '重新开始',
    'games.dialogueError': '角色回应生成失败：{message}',
  ...
  fr: {
    ...
    'games.close': 'Fermer', 'games.reset': 'Recommencer', 'games.dialogueError': 'Échec de la réponse du personnage : {message}',
    ...
    'gomoku.blackWins': 'Les noirs gagnent', 'gomoku.whiteWins': 'Les blancs gagnent', 'gomoku.draw': 'Égalité', 'gomoku.thinking': '{name} réfléchit…', 'gomoku.yourTurn': 'À vous de jouer', 'gomoku.game': 'Jeu', 'gomoku.organizing': '{name} prépare sa réponse…',
  ...
  ru: {
    ...
    'games.close': 'Закрыть', 'games.reset': 'Начать заново', 'games.dialogueError': 'Не удалось создать реплику персонажа: {message}',
    'gomoku.subtitle': 'Вы играете чёрными, {name} — белыми.', 'gomoku.liveChat': 'Живой диалог', 'gomoku.personalityOutput': 'Речь персонажа',
    'gomoku.blackWins': 'Чёрные победили', 'gomoku.whiteWins': 'Белые победили', 'gomoku.draw': 'Ничья', 'gomoku.thinking': '{name} думает…', 'gomoku.yourTurn': 'Ваш ход', 'gomoku.game': 'Игра', 'gomoku.organizing': '{name} готовит ответ…',
  ...
  ja: {
    ...
    'games.close': '閉じる', 'games.reset': 'やり直す', 'games.dialogueError': 'キャラクターの返答生成に失敗しました：{message}',
    'gomoku.subtitle': 'あなたは黒、{name} は白で対局します。', 'gomoku.liveChat': 'ライブ会話', 'gomoku.personalityOutput': 'キャラクター表現',
    'gomoku.blackWins': '黒の勝ち', 'gomoku.whiteWins': '白の勝ち', 'gomoku.draw': '引き分け', 'gomoku.thinking': '{name} が考えています…', 'gomoku.yourTurn': 'あなたの番です', 'gomoku.game': 'ゲーム', 'gomoku.organizing': '{name} が返答を考えています…',
