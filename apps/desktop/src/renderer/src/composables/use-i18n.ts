...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'chat.suggestion.project': 'Continue a project',
    'chat.suggestion.skill': 'Practice a skill',
    'chat.suggestion.personal': 'A personal idea',
    'chat.suggestion.build': 'Build something',
    'chat.suggestion.learn': 'Learn something',
    'chat.suggestion.game': 'Play chess',
    'chat.suggestionPrompt.project': 'Continue the most relevant active project you remember me working on. Tell me one concrete next step, then help me start it.',
    'chat.suggestionPrompt.skill': 'Based on the skills and learning goals you remember, give me one focused challenge. Let me try before revealing the answer.',
    'chat.suggestionPrompt.personal': 'Use what you remember about my interests and preferences to suggest one worthwhile thing we can do now, and help me begin.',
    'chat.suggestionPrompt.build': 'Help me build a small useful feature in a focused session. Make a sensible first move and explain it briefly.',
    'chat.suggestionPrompt.learn': 'Teach me one practical concept related to my interests, with a short example and a tiny exercise.',
    'chat.suggestionPrompt.game': 'Let’s play a quick game of chess.',
  ...
  zh: {
    ...
    'chat.suggestion.project': '继续一个项目',
    'chat.suggestion.skill': '练习一项技能',
    'chat.suggestion.personal': '给我一个个性化点子',
    'chat.suggestion.build': '动手做点东西',
    'chat.suggestion.learn': '学点新东西',
    'chat.suggestion.game': '来一盘国际象棋',
    'chat.suggestionPrompt.project': '继续你之前提到的最相关项目。先告诉我一个明确的下一步，然后帮我开始。',
    'chat.suggestionPrompt.skill': '根据你记得的我的技能和学习目标，给我一个专注的小挑战。先让我尝试，再公布答案。',
    'chat.suggestionPrompt.personal': '结合你记得的我的兴趣和偏好，推荐一件现在值得做的事，并帮我开始。',
    'chat.suggestionPrompt.build': '陪我在一次专注的短时任务中做一个实用的小功能。请先采取合理的第一步，并简短说明。',
    'chat.suggestionPrompt.learn': '结合我的兴趣教我一个实用概念，给出简短示例和一个小练习。',
    'chat.suggestionPrompt.game': '我们来下一盘国际象棋吧。',
  ...
  fr: {
    ...
    'chat.suggestion.project': 'Reprendre un projet',
    'chat.suggestion.skill': 'Pratiquer une compétence',
    'chat.suggestion.personal': 'Une idée pour vous',
    'chat.suggestion.build': 'Créer quelque chose',
    'chat.suggestion.learn': 'Découvrir un sujet',
    'chat.suggestion.game': 'Jouer aux échecs',
    'chat.suggestionPrompt.project': 'Reprenez le projet actif le plus pertinent dont vous vous souvenez. Donnez-moi une prochaine étape concrète, puis aidez-moi à la commencer.',
    'chat.suggestionPrompt.skill': 'À partir des compétences et objectifs d’apprentissage dont vous vous souvenez, proposez-moi un défi ciblé. Laissez-moi essayer avant de révéler la réponse.',
    'chat.suggestionPrompt.personal': 'Servez-vous de ce que vous savez de mes intérêts et préférences pour proposer une activité utile à faire maintenant, puis aidons-nous à la commencer.',
    'chat.suggestionPrompt.build': 'Aidez-moi à créer une petite fonctionnalité utile lors d’une session ciblée. Faites un premier pas raisonnable et expliquez-le brièvement.',
    'chat.suggestionPrompt.learn': 'Apprenez-moi un concept pratique lié à mes intérêts, avec un bref exemple et un petit exercice.',
    'chat.suggestionPrompt.game': 'Jouons rapidement aux échecs.',
  ...
  ru: {
    ...
    'chat.suggestion.project': 'Продолжить проект',
    'chat.suggestion.skill': 'Потренировать навык',
    'chat.suggestion.personal': 'Идея для меня',
    'chat.suggestion.build': 'Что-нибудь создать',
    'chat.suggestion.learn': 'Узнать новое',
    'chat.suggestion.game': 'Сыграть в шахматы',
    'chat.suggestionPrompt.project': 'Продолжи самый актуальный активный проект, о котором ты помнишь. Назови один конкретный следующий шаг и помоги мне начать.',
    'chat.suggestionPrompt.skill': 'Опираясь на навыки и учебные цели, которые ты помнишь, предложи одну небольшую задачу. Дай мне попробовать до того, как покажешь ответ.',
    'chat.suggestionPrompt.personal': 'Используй то, что помнишь о моих интересах и предпочтениях, чтобы предложить полезное занятие на сейчас и помочь мне начать.',
    'chat.suggestionPrompt.build': 'Помоги мне за короткую сосредоточенную сессию создать небольшую полезную функцию. Сделай разумный первый шаг и кратко объясни его.',
    'chat.suggestionPrompt.learn': 'Объясни практическую идею, связанную с моими интересами, на коротком примере и небольшом упражнении.',
    'chat.suggestionPrompt.game': 'Давай сыграем в шахматы.',
  ...
  ja: {
    ...
    'chat.suggestion.project': 'プロジェクトを続ける',
    'chat.suggestion.skill': 'スキルを練習する',
    'chat.suggestion.personal': '自分向けのアイデア',
    'chat.suggestion.build': '何か作ってみる',
    'chat.suggestion.learn': '新しいことを学ぶ',
    'chat.suggestion.game': 'チェスをする',
    'chat.suggestionPrompt.project': '覚えている中で最も関連性の高い進行中のプロジェクトを続けてください。具体的な次の一歩を一つ挙げて、始めるのを手伝ってください。',
    'chat.suggestionPrompt.skill': '覚えている私のスキルや学習目標に合わせて、集中できる課題を一つ出してください。答えを見せる前に、まず私に挑戦させてください。',
    'chat.suggestionPrompt.personal': '覚えている私の興味や好みに合わせて、今できる価値あることを一つ提案し、始めるのを手伝ってください。',
    'chat.suggestionPrompt.build': '短い集中セッションで、役立つ小さな機能を一緒に作ってください。妥当な最初の一歩を進め、簡潔に説明してください。',
    'chat.suggestionPrompt.learn': '私の興味に関連する実用的な概念を、短い例と小さな練習問題で教えてください。',
    'chat.suggestionPrompt.game': 'チェスを一局しよう。',
